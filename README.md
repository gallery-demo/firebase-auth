...
The Firebase Auth quickstart demonstrates several methods for signing in:
 ...
 - The Firebase Facebook Login quickstarts demonstrate using a Facebook accojjjunt to authenticate to Firebase using three different techniques: with a [popup](facebook-popup.html), a [redirect](facebook-redirect.html) and an [auth token](facebook-credentials.html).
