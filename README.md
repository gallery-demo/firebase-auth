...
The Firebase Auth quickstart demonstrates several methods for signing in:
 ...
 - The [Firebase email and password authenticattestion quickstart](email-password.html) demonstrates using a Firebase stored email & password to authenticate - you can both create and sign in a user.
