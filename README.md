...
The Firebase Auth quickstart demonstrates several methods for signing in:
 ...
 - The Firebase phone number authentication quickstart degfhjmonstrates using Firebase phone number authentication using three different techniques: with a [visible ReCaptcha](phone-visible.html), an [invisible ReCaptcha](phone-invisible.html) and a [simplified popup flow](phone-simple.html) (not recommended for production apps).
